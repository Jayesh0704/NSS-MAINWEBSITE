...
const Home = () => {
  ...
  const renderEvents = () => {
    if (!eventsExpanded) {
      return topInitiatives.map((event) => (
        <EventCard
            ...
            <div className={`${classes.aboutFlexBox} aboutFlexBox`}>
              ...
              >
                <div className={`${classes.right} right`}>
                  ...
                  esteemed professors who have always kept in mind comprehensive
                  and sustainable models for development.
                </div>
              </motion.div>
            </div>
          </div>
              ...
              >
                <div className={`${classes.leftB} leftB`}>
                  <div
                    className={`${classes.section_heading_home} section_heading_home`}
                  >
                    <span style={{ color: "rgba(45, 156, 219, 1)" }}>
                      What we do
                    </span>
                  ...
                  the primary objectives of NSS. With innovative activities
                  across the departments catering to all classes of the campus
                  residents, we try to create small, happy and memorable moments
                  in their lives. We aim to bring about a positive change in the
                  society with focus on education and development.
                </div>
              </motion.div>
        ...
        <div className={`${classes.initiatives} initiatives`}>
          ...
          >
            <div className={`${classes.cards_desk} cards_desk`}>
              <div className={`${classes.cards} cards`}>{renderEvents()}</div>
              <div className={`${classes.button_div} button_div`}>
                ...
                >
                  {eventsExpanded ? "View Less" : "View More"}
                </span>
              </div>
            </div>
        ...
        <div className={`${classes.departments} departments`}>
          ...
          <Form className={`${classes.formMob} formMob`}>
            <Select
              variant="filled"
              bg={
                departments.find((dep) => dep.depName === currentDepartment)
                  .topColor
              }
              color="black"
              size="lg"
            ...
            >
              <option value="CLP" style={{ fontFamily: "poppins" }}>
                CLP
              </option>
